...
class CLIP_FCCLIP(Backbone):
    def __init__(self, cfg, input_shape):
        super().__init__()
        model_name = cfg.MODEL.SCORE.CLIP_MODEL_NAME
        pretrained= cfg.MODEL.SCORE.CLIP_PRETRAINED_WEIGHTS
        ...
        self.clip_model = open_clip.create_model_and_transforms(model_name, pretrained=pretrained)[0]
